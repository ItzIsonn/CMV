...
public class ConstructorValue extends RuntimeValue<Object> {
    ...
    public ConstructorValue(ArrayList<CallArgExpression> args, ArrayList<Statement> body, ConstructorDeclarationEnvironment parentEnvironment, Set<String> accessModifiers) {
        super(null);
        this.args = args;
        this.body = body;
