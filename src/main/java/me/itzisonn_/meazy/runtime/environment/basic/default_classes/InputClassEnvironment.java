...
public class InputClassEnvironment extends BasicClassEnvironment {
    public InputClassEnvironment(Environment parent) {
        ...
        declareFunction("read", new DefaultFunctionValue(new ArrayList<>(), DataType.STRING, this, Set.of("shared")) {
        ...
        declareFunction("readLine", new DefaultFunctionValue(new ArrayList<>(), DataType.STRING, this, Set.of("shared")) {
            public RuntimeValue<?> run(ArrayList<RuntimeValue<?>> functionArgs, Environment functionEnvironment) {
                return new StringValue(Utils.SCANNER.nextLine());
            }
        });

        declareFunction("readInt", new DefaultFunctionValue(new ArrayList<>(), DataType.INT, this, Set.of("shared")) {
            public RuntimeValue<?> run(ArrayList<RuntimeValue<?>> functionArgs, Environment functionEnvironment) {
                return new IntValue(Utils.SCANNER.nextInt());
            }
        });

        declareFunction("readFloat", new DefaultFunctionValue(new ArrayList<>(), DataType.FLOAT, this, Set.of("shared")) {
            public RuntimeValue<?> run(ArrayList<RuntimeValue<?>> functionArgs, Environment functionEnvironment) {
